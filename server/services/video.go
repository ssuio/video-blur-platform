...
func (vs VideoService) CreateVideo(id string, ownerID string, name string, description string, size int64, createdTime string) (error) {
...
func (vs VideoService) ListVideos(ownerID string) ([]model.Video, error){
